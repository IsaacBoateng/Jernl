...
import 'package:jernl/blocs/journal_edit_bloc_provider.dart';
import 'package:jernl/classes/FormatDates.dart';
import 'package:jernl/classes/mood_icons.dart';
import 'package:jernl/models/journal.dart';
import 'package:jernl/pages/edit_entry.dart';
import 'package:jernl/services/db_firestore.dart';
import 'package:firebase_admob/firebase_admob.dart';

const String AD_MOB_APP_ID = 'ca-app-pub-5748366651113985~1827661456';
const String AD_MOB_TEST_DEVICE = 'test_device_id - run ad then check device logs for value';
const String AD_MOB_AD_ID = 'ca-app-pub-5748366651113985/5467523562';
...
class Home extends StatefulWidget {
  ...
  BannerAd createBannerAd() {
    return new BannerAd(
      adUnitId: 'ca-app-pub-5748366651113985~1827661456',
  ...
  void initState() {
    ...
    FirebaseAdMob.instance.initialize(appId: 'ca-app-pub-5748366651113985~1827661456');
...
class _HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Jernl', style: TextStyle(color: Colors.lightBlue.shade800),),
        elevation: 0.0,
